...
func (ec *Client) CallContractEx(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int, overrides *map[common.Address]OverrideAccount, debug bool, needLogs bool) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(

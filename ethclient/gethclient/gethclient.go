...
// needLogs indicates whether events emitted by evm call are returned
func (ec *Client) CallContractEx(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int, overrides *map[common.Address]OverrideAccount, debug, needLogs bool) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(
